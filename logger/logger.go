...
func (lc Logger) log(logLevel string, msg string, labels []string) error {
...
func (lc Logger) saveToLogFile(prefix string, message string) error {
	if lc.logTarget == "" {
		return nil
	}
...
func (lc Logger) Info(msg string, labels ...string) error {
	return lc.log(InfoLog, msg, labels)
}

// Log a TRACE level message
func (lc Logger) Trace(msg string, labels ...string) error {
	return lc.log(TraceLog, msg, labels)
}

// Log a DEBUG level message
func (lc Logger) Debug(msg string, labels ...string) error {
	return lc.log(DebugLog, msg, labels)
}

// Log a WARN level message
func (lc Logger) Warn(msg string, labels ...string) error {
	return lc.log(WarnLog, msg, labels)
}

// Log an ERROR level message
func (lc Logger) Error(msg string, labels ...string) error {
	return lc.log(ErrorLog, msg, labels)
}

// Build the log entry object
func (lc Logger) buildLogEntry(logLevel string, msg string, labels []string) LogEntry {
	res := LogEntry{}
	res.Level = logLevel
	res.Message = msg
	res.Labels = labels
...
func (lc Logger) sendLog(logEntry LogEntry) error {
	if lc.logTarget == "" {
		return nil
	}
